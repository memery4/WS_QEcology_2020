---
title: "Nonlinear_Assignment2_Light_Curve"
...
# 2. Initial: create a function that calculates the intial values from the data
...
Model with intial values in the model: 
```{r}
